...
<html lang="es">
<head>
    <link rel="stylesheet" href="estilos/pagos.css">
    <meta charset="utf-8">
...
<section class="descrip">
    <div>
        <h2 style="margin: 100px 0px 0px 300px">Escoge tu forma de pago.</h2>
    </div>
...
<section  class="sec" style="width: 800px;margin: 100px 600px 0px 0px;padding: 10px 0px 0px 0px; "align="center" >
        ...
        <div class="text" style=" margin:  0px 0px 20px 50px;width: 700px;height: 350px" align="center">
            <div style="margin: -100px 0px 0px -1050px">
               <img src="imagenes/tarjeta.png" style="width: 50px; height: 40px;margin: 50px 0px 0px 300px">
            </div>
            <div>
                <button class="boton" type="submit"><h3>Pago con tarjeta</h3></button>
            </div>
            <div style="margin: -50px 0px 0px 100px">
               <img src="imagenes/billete.jpg"style="width: 80px; height: 50px;">
            </div>
            <div>
                <button class="boton2" type="submit"><h3>Pago con tarjeta</h3></button>
            </div>
