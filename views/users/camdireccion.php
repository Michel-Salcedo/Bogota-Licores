...
<html lang="es">
<head>
    <link rel="stylesheet" href="estilos/camdireccion.css">
    <meta charset="utf-8">
...
<section  class="sec" style="width: 800px;margin: 100px 600px 0px 0px;padding: 10px 0px 0px 0px; "align="center" >
        ...
        <div class="text" style=" margin:  0px 0px 20px 50px;width: 700px;height: 350px" align="center">
            ...
            <h3>Cambiar dirección de envio</h3>
            </div>
            <form>
        ...
        <button class="boton" type="submit"><h3>GUARDAR CAMBIOS</h3></button>
    </form>
    </section>
    <div style="margin: 40px 0px 0px 1100px;position: absolute;">
        <img src="post.jpg" style="width: 500px;height: 500px;">
